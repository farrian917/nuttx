...
#ifndef __INCLUDE_NUTTX_IOEXPANDER_PCA9539_H
#define __INCLUDE_NUTTX_IOEXPANDER_PCA9539_H
...
struct pca9539_config_s
{
  ...
  /* Sets the state of the PCA9539's nReset pin */
  ...
  CODE int  (*attach)(FAR struct pca9539_config_s *state, xcpt_t isr,
                      FAR void *arg);
  CODE void (*enable)(FAR struct pca9539_config_s *state, bool enable);
#endif
};
...
FAR struct ioexpander_dev_s *pca9539_initialize(FAR struct i2c_master_s *dev,
                                        FAR struct pca9539_config_s *config);
