...
#ifndef __BOARDS_ARM_STM32_STM32F103_MINI_MTH_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32_STM32F103_MINI_MTH_INCLUDE_BOARD_H
...
/* PLL source is HSE/1, PLL multiplier is 6: PLL frequency is
 * 12MHz (XTAL) x 6 = 72MHz
 */
