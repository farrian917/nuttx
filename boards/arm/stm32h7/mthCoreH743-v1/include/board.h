...
/* USB OTG ULPI */
#define GPIO_OTG_HS_ULPI_CK  (GPIO_OTG_HS_ULPI_CK_0|GPIO_SPEED_100MHz) /* PA5 */
#define GPIO_OTG_HS_ULPI_D0  (GPIO_OTG_HS_ULPI_D0_0|GPIO_SPEED_100MHz) /* PA3 */
#define GPIO_OTG_HS_ULPI_D1  (GPIO_OTG_HS_ULPI_D1_0|GPIO_SPEED_100MHz) /* PB0 */
#define GPIO_OTG_HS_ULPI_D2  (GPIO_OTG_HS_ULPI_D2_0|GPIO_SPEED_100MHz) /* PB1 */
#define GPIO_OTG_HS_ULPI_D3  (GPIO_OTG_HS_ULPI_D3_0|GPIO_SPEED_100MHz) /* PB10 */
#define GPIO_OTG_HS_ULPI_D4  (GPIO_OTG_HS_ULPI_D4_0|GPIO_SPEED_100MHz) /* PB11 */
#define GPIO_OTG_HS_ULPI_D5  (GPIO_OTG_HS_ULPI_D5_0|GPIO_SPEED_100MHz) /* PB12 */
#define GPIO_OTG_HS_ULPI_D6  (GPIO_OTG_HS_ULPI_D6_0|GPIO_SPEED_100MHz) /* PB13 */
#define GPIO_OTG_HS_ULPI_D7  (GPIO_OTG_HS_ULPI_D7_0|GPIO_SPEED_100MHz) /* PB5 */
#define GPIO_OTG_HS_ULPI_DIR (GPIO_OTG_HS_ULPI_DIR_2|GPIO_SPEED_100MHz) /* PI11 */
#define GPIO_OTG_HS_ULPI_NXT (GPIO_OTG_HS_ULPI_NXT_1|GPIO_SPEED_100MHz) /* PC3 */
#define GPIO_OTG_HS_ULPI_STP (GPIO_OTG_HS_ULPI_STP_0|GPIO_SPEED_100MHz) /* PC0 */
